    ...
    <header className="bg-byuNavy text-white p-4 md:p-6 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <nav className="mt-4 flex flex-col sm:flex-row items-center gap-2 sm:gap-4 justify-center">
          ...
          <button onClick={() => navigate('/profile')} className="bg-byuRoyal hover:bg-blue-700 px-4 py-2 rounded-full text-sm font-semibold w-full sm:w-auto text-center" title="My Profile">Profile</button>
