    ...
    <header className="bg-byuNavy text-white p-6  font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <nav className="mt-4 flex gap-4 justify-center">
          <a href="tel:8014223035" className="bg-byuRoyal hover:bg-gray-700 px-4 py-2 rounded-full text-sm font-semibold" title="BYU Counseling and Psychological Services">Call CAPS</a>
          <a href="https://caps.byu.edu/for-students-in-crisis" target="_blank" rel="noopener noreferrer" className="bg-byuRoyal hover:bg-gray-700 px-4 py-2 rounded-full text-sm font-semibold" title="BYU Crisis Resources">Crisis Resources</a>
        </nav>
      </div>
    </header>
  );
