  ...
  return (
    ...
    <div ref={rootRef} className="fixed bottom-6 right-6 z-50">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className="h-12 w-12 inline-flex items-center justify-center rounded-full bg-byuRoyal text-white shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-300"
      >
        ...
        >
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">Configure voice, language, and page theme.</p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <div className="mt-2 flex gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-byuRoyal px-3 py-2 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-indigo-200"
                >
                  Preview
                </button>
              </div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                {LANGUAGES.map((lang) => (
                  <button
                    ...
                    className={`justify-start rounded-lg border px-3 py-2 text-sm text-left ${
                      language === lang.code
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-2">
                <label className="inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-sm cursor-pointer select-none">
                  <input
                    type="radio"
                    name="theme"
                    value="system"
            ...
            <div className="mt-1 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-md bg-red-50 px-3 py-2 text-sm text-red-600 hover:bg-red-100 focus:outline-none"
                >
                  Sign out
                </button>
              </div>
